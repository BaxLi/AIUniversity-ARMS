...
results_human = model_human.predict('uploads', conf = 0.5, verbose = False, classes = [0]) #set up the prediction of human model
results_gun = model_gun.predict(image, conf = 0.5, verbose = False, classes = [2]) #set up the prediction of gun model
